...
class CountdownTimer:
    ...
    def __init__(self):
        ...
        self.root.title("Countdowm Timer")
        
        self.time_entry = tk.Entry(self.root, font=("Helvetica", 30))
        self.time_entry.grid(row=0, column=0, columnspan=2, padx=6, pady=5)    
    ...
    def start(self):
        ...
        if not self.stop_loop:
            toast = ToastNotifier()
            toast.show_toast("CountdownTimer", "Time is up!", duration=0)
            playsound('C:/Users/User/Desktop/pymusic.mp3')
    def stop(self):
        self.stop_loop = True
